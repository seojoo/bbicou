...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { description: @coupon.description, image: @coupon.image, location: @coupon.location, title: @coupon.title }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { description: @coupon.description, image: @coupon.image, location: @coupon.location, title: @coupon.title }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
